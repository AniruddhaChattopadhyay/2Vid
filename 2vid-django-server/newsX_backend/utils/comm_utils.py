...
from newsX_backend.utils.db_utils import get_video_links, get_raw_news_by_id
from newsX_backend.mappers.language_mapper import db_language_code_dict
from newsX_backend.enums.model_enums import RawNewsEnum, VideoLinksEnum, LanguagesEnum
...
def send_mail(news_id_response: NewsIdResponse, languages):
    ...
    news_dict= get_raw_news_by_id(news_id_list)[0]
    if news_dict[RawNewsEnum.title.value] == "Video from google forms":
        RECIEVER_LIST.append(news_dict[RawNewsEnum.author.value])
