...
from .views import NewsGeneration, NewsGenerationByURL, ProcessNewsFromURL, UpdateLanguageTable, process_form_view, show_submission ,  ScriptToVideo , UrlToVideo
